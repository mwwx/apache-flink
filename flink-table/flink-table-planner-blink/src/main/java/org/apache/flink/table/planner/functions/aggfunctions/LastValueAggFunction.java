...
public class LastValueAggFunction<T> extends AggregateFunction<T, GenericRowData> {
	...
	/**
	 * TimestampWithoutTimeZoneLastValueAggFunction.
	 */
	public static class TimestampWithoutTimeZoneLastValueAggFunction extends LastValueAggFunction<TimestampData> {
