...
/**
 * JdbcRetractTableSinkFactoryTest.
 */
public class JdbcRetractTableSinkFactoryTest {
	...
	public void testJDBCSinkProperties() {
		...
		properties.put("update-mode", "retract");
		...
		final JdbcRetractTableSink expected = JdbcRetractTableSink.builder()
			.setOptions(options)
